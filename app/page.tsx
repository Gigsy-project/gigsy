...
export default function HomePage() {
  ...
  const [selectedAction, setSelectedAction] = useState("buscar")
                  ...
                  <Select value={selectedAction} onValueChange={setSelectedAction}>
                    <SelectTrigger className="w-full h-14 text-base rounded-xl min-h-[56px]">
                      <div className="flex items-center gap-2 flex-1 justify-start">
                        ...
                        <SelectValue placeholder="Selecciona una acción" className="text-left" />
                      </div>
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="buscar">Buscar servicio ahora</SelectItem>
                      <SelectItem value="publicar">Publicar tarea</SelectItem>
                    </SelectContent>
                  </Select>
              ...
              {features.map((feature, index) => (
                <Card key={index} className="border-0 shadow-none bg-transparent">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed text-center line-clamp-2">{feature.description}</p>
                  </CardContent>
                </Card>
              ))}
            </div>
